...
const TRANSLATIONS = {
  "en": {
    ...
    "tile_queue_title": "OPD Queue Monitor",
    "tile_queue_desc": "Check simulated queue position & token waiting status",
    ...
    "tile_beds_desc": "Simulated ICU, ventilator & oxygen bed occupancy",
    ...
    "modal_queue_title": "OPD Token Display (Simulated)",
    "modal_doctors_title": "Hospital Specialist Doctors Directory",
    "modal_beds_title": "Hospital Bed & ICU Capacity (Simulated)",
    ...
    "sec_queue": "OPD Token Display (Simulated)",
    ...
    "sec_beds": "Hospital Bed & ICU Capacity (Simulated)",
  ...
  "hi": {
    ...
    "tile_queue_title": "ओपीडी कतार मॉनिटर",
    "tile_queue_desc": "कतार स्थिति और टोकन प्रतीक्षा समय देखें (डेमो)",
    ...
    "tile_beds_desc": "आईसीयू, वेंटिलेटर और ऑक्सीजन बेड उपलब्धता (सिम्युलेटेड)",
    ...
    "modal_queue_title": "ओपीडी टोकन डिस्प्ले (सिम्युलेटेड)",
    "modal_doctors_title": "अस्पताल विशेषज्ञ डॉक्टर डायरेक्टरी",
    "modal_beds_title": "अस्पताल बेड और आईसीयू स्थिति (सिम्युलेटेड)",
  ...
  "pa": {
    ...
    "tile_queue_title": "ਓਪੀਡੀ ਕਤਾਰ ਮਾਨੀਟਰ",
    "tile_queue_desc": "ਕਤਾਰ ਸਥਿਤੀ ਅਤੇ ਟੋਕਨ ਉਡੀਕ ਦੇਖੋ (ਡੈਮੋ)",
    ...
    "tile_beds_desc": "ਆਈਸੀਯੂ, ਵੈਂਟੀਲੇਟਰ ਅਤੇ ਆਕਸੀਜਨ ਬੈੱਡ (ਸਿਮੂਲੇਟਿਡ)",
    ...
    "modal_queue_title": "ਓਪੀਡੀ ਟੋਕਨ ਡਿਸਪਲੇਅ (ਸਿਮੂਲੇਟਿਡ)",
    "modal_doctors_title": "ਸਾਡੇ ਮਾਹਰ ਹਸਪਤਾਲ ਡਾਕਟਰ",
    "modal_beds_title": "ਹਸਪਤਾਲ ਬੈੱਡ ਅਤੇ ਆਈਸੀਯੂ ਸਥਿਤੀ (ਸਿਮੂਲੇਟਿਡ)",
